...
public class CalculatorView extends JFrame {
	...
	public JButton btnPer, btnEdit, btnReset, btnBack, btnSqr, btnSqrt, btnDiv, btnRev, btn9, btn7, btn8, btnMul, btn4, btn5, btn6, btnSub, btn1, btn2, btn3, btnAdd, btnAlt, btn0, btnPoint, btnResult;
	...
	@Override
	public int hashCode() {
		return Objects.hash(btn0, btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btnAdd, btnAlt, btnBack, btnDiv,
				btnEdit, btnMul, btnPer, btnPoint, btnReset, btnResult, btnRev, btnSqr, btnSqrt, btnSub,
				calculatorModel, contentPane, lbl_InputValue, lbl_MValue);
	}
	...
	public void init() {
		...
		//Button for Pow
		 btnSqr = new JButton("a^2");
		btnSqr.setFont(new Font("Tahoma", Font.PLAIN, 30));
		btnSqr.addActionListener(calculatorController);
